...
export class Backend implements backendInterface {
    ...
    async getMyReports(): Promise<Array<AnalysisReport>> {
        if (this.processError) {
            try {
    ...
    async getReport(arg0: ReportId): Promise<AnalysisReport> {
        if (this.processError) {
            try {
    ...
    async submitAnalysis(arg0: string, arg1: string, arg2: string, arg3: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitAnalysis(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
